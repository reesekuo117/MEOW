...
$pageName ='會員中心'; //頁面名稱
    ...
    $f_sql = "SELECT * FROM `love` Inner join draw on target_type = 3 and draw.sid = love.collect_sid WHERE love.member_id=$member_id";
    $d_sql = "SELECT * FROM `love` Inner join forturn on target_type = 4 and forturn.sid = love.collect_sid WHERE love.member_id=$member_id";
