...
<div class="body_draw04 d-none d-md-block">
    ...
    <div class="drawSection17 position-relative">
        <a id="backtodraw16" class="position-absolute backto d-none" href="draw03.php">
        ...
        <div class="container flex-row drop-area">
            ...
            <!-- <div id="info"></div> -->
            <!-- <div class="drop-area">
                <div class="drag position-absolute">
