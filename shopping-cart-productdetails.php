                                        ...
                                        <tbody class="tbody">
                                            ...
                                            foreach ($_SESSION["pcart"] as $k => $v) : ?>
                                                <tr class="parentKen">
                                                    ...
                                                    <!-- 小計 -->
                                                    <td class="LittlePriceYu" data-val=" <?= $v['product_price'] * $v['qty'] ?>">
                    ...
                    <div class=" field order-address-yu p-3">
                        ...
                        <div class="d-flex align-items-center">
                            <div class="form-group m-0">
                                <select class="orderaddress1-yu" name="orderaddress1-yu" id="city1-yu" type="address_city" required value="<?= htmlentities($sm['address_city_re']) ?>">
    ...
    <div id="myTabContent-yu" class="container">
        ...
        <section class="mdsection-2-yu">
            ...
            <div class="mdorder-list-yu">
                ...
                <div class="mdorder-email-yu p-3">
                    <label for="email" class="">Email<span style="color: #963c38">*</span>
                    </label>
                    <br />
        ...
        <div class=" d-flex justify-content-center">
            ...
            <a href="shopping-cart-ATM-product.php" class="btn mdunique-nextbutton-yu">
                <button class=" mdunique-btn-yu  me-md-2" type="button" type="submit" name=ok value="送出" onclick="if(confirm('你確定送出嗎?')) return true;else return false">
                    <p class="m-0 text-center">
                        確認訂購
                    </p>
                </button>
