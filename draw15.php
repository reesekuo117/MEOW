...
<?php include __DIR__. '/parts/navbar.php'; ?>
    ...
    <div class="drawSection15 position-relative">
        <a id="backtodraw12" class="position-absolute backto" href="draw12.php">
        ...
        <div class="container">
            ...
            <div class="page15Cat mx-auto mt-4">
