...
<div class="body_lb">
        ...
        <div class="row m-0">
            <ul class="w-100 mb-0 list-unstyled d-flex justify-content-center links-group_lb">
                <li class="mx-1 my-1 active">
                    <a class=" mbactive_lb" href="#mbmoonold_lb"><p class="s_lb mb-0 py-1">關於月老</p></a>
                </li>
                <li class="mx-1 my-1">
                    <a class="" href="#byebye_lb"><p class="s_lb mb-0 py-1">參拜流程</p></a>
                    </li>
                <li class="mx-1 my-1">
                    <a href="#mbnotice_lb"><p class="s_lb mb-0 py-1">參拜禁忌</p></a>
                </li>
                <li class="mx-1 my-1">
                    <a href="#givebk_lb"><p class="s_lb mb-0 py-1">如何還願</p></a>
                </li>
                <li class="mx-1 my-1">
                    <a href="#selected-temple_lb"><p class="s_lb mb-0 py-1">精選月老廟</p></a>
                </li>
            </ul>
        </div>
    </div>
        ...
        <div class="position-relative container-fluid section1_lb targetScrollSection d-none d-md-block p-0" id="moonold_lb">
            ...
            <div class="position-relative tempic-group_lb d-none d-md-block">
                ...
                <div class="pic-group_lb">
                    ...
                    <div class="row mt-2 tmp-pic2_lb">
                        <div class="col-1"></div>
    ...
    <!-- 參拜月老禁忌-pc -->
    <div class="container section3_lb targetScrollSection d-none d-md-block" id="notice_lb">
        <h1 class="text-center">參拜月老禁忌</h1>
        <div class="row pt-5 d-flex justify-content-center">
            ...
            <div class="ban-card col-4 offset-1">
                <div class="face_lb face1_lb">
                    <div class="ban-card-content">
                        <div class="ban-img-wrap">
    ...
    <div class="container-fluid targetScrollSection selected-temple_lb d-none d-md-block" id="selected-temple_lb">
        <div class="d-flex">
            <div class="map-wrap  position-relative col-6">
                ...
                <svg  class="mapsvg_lb" version="1.1" id="cf503461-00bd-459a-aeb5-062ebc913211"
                     xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 595.3 841.9"
                     style="enable-background:new 0 0 595.3 841.9;" xml:space="preserve">
                <style type="text/css">
                    .st0{fill:#F5DFC2;stroke:#FFFFFF;stroke-miterlimit:10;}
    ...
    <div class="container d-none d-md-block">
        <h2 class="text-center">月老喵誠心推薦</h2>
        <div class="otherp">
            <div class="container">
                <h4>瀏覽此商品的人，也看了...</h4>
                                                ...
                                                <div class="img-box">
                                                    <img src="./imgs/product/P20_4.jpg" class="img-fluid" alt="">
                                                        <div class="icon_heart">
                                                            <svg class="heart_line" width="32" height="32" viewBox="0 0 32 32"
