...
<!-- <link rel="stylesheet" href="shopping-cart-travellist-index.js"> -->
    ...
    <div id="myTabContent-yu" class="container">
        ...
        <div class=" d-md-flex justify-content-md-end">
            ...
            <a href="shopping-cart-creditcard-travel.html" class="btn unique-nextbutton-yu">
                <button class=" unique-btn-yu  me-md-2 que-btn-yu" type="submit" name=ok value="送出" onclick="if(confirm('您確定送出嗎?')) return true;else return false">
